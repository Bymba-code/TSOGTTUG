...
const UPDATE_STUDENT_SCHELUDE = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const student_schelude = await prisma.user_schelude.findUnique({
        ...
        // 💾 Мэдээллийг шинэчлэх
        const result = await prisma.user_schelude.update({
            where: { id: parseInt(id) },
            data: updateData
        });
...
module.exports = UPDATE_STUDENT_SCHELUDE;
